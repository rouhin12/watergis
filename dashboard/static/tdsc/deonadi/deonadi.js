...
'Deonadi Watershed contour line':'geonode:deonadi_dem_countor_4326'
};
var tempParameter;
var soil_legend;
...
function addWMSLegend(layer){
    lagendGraphic = "https://geoserver2.communitygis.net/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER="+layer;
